...
app.get("/vlogin.html", (req, res) => {
  res.render("vollogin", { title: "Welcome!" })
})

app.get(
  "https://api.signupgenius.com/v2/k/signups/created/all/?user_key=V0FzMkxZcmVOZlVnclZMVEl6dGhWQT09",
  (req, res) => {
